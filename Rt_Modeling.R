...
points(x,S2,col="red")
lines(x,S2,col="red",lty=1)
#max(S2)
#min(S2)
#S2[p.t.end]
points(x, S2a, col="purple")
lines(x, S2a, col="purple",lty=1)
#max(S2a)
#min(S2a)
#S2a[p.t.end]
points(x, S2b, col="blue")
lines(x, S2b, col="blue",lty=1)
#max(S2b)
#min(S2b)
#S2b[p.t.end]
points(x, S2c, col="green")
...
#min(I2)
#I2[p.t.end]
points(x, I2a, col="purple")
lines(x, I2a, col="purple",lty=1)
#max(I2a)
#min(I2a)
#I2a[p.t.end]
points(x, I2b, col="blue")
lines(x, I2b, col="blue",lty=1)
#max(I2b)
#min(I2b)
#I2b[p.t.end]
points(x, I2c, col="green")
...
#min(R2)
#R2[p.t.end]
points(x, R2a, col="purple")
lines(x, R2a, col="purple",lty=1)
#max(R2a)
#min(R2a)
#R2a[p.t.end]
points(x, R2b, col="blue")
lines(x, R2b, col="blue",lty=1)
#max(R2b)
#min(R2b)
#R2b[p.t.end]
points(x, R2c, col="green")
...
points(x,S3,col="red")
lines(x,S3,col="red",lty=1)
#max(S3)
#min(S3)
#S3[p.t.end]
points(x, S3a, col="purple")
lines(x, S3a, col="purple",lty=1)
#max(S3a)
#min(S3a)
#S3a[p.t.end]
points(x, S3b, col="blue")
lines(x, S3b, col="blue",lty=1)
#max(S3b)
#min(S3b)
#S3b[p.t.end]
points(x, S3c, col="green")
...
#min(I3)
#I3[p.t.end]
points(x, I3a, col="purple")
lines(x, I3a, col="purple",lty=1)
#max(I3a)
#min(I3a)
#I3a[p.t.end]
points(x, I3b, col="blue")
lines(x, I3b, col="blue",lty=1)
#max(I3b)
#min(I3b)
#I3b[p.t.end]
points(x, I3c, col="green")
...
#min(R3)
#R3[p.t.end]
points(x, R3a, col="purple")
lines(x, R3a, col="purple",lty=1)
#max(R3a)
#min(R3a)
#R3a[p.t.end]
points(x, R3b, col="blue")
lines(x, R3b, col="blue",lty=1)
#max(R3b)
#min(R3b)
#R3b[p.t.end]
points(x, R3c, col="green")
